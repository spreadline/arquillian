...
public class JMXTestRunnerTestCase
{
   ...
   public void testJMXTestRunner() throws Throwable
   {
      ...
      try
      {
         ...
         props.put(ExecutionType.class.getName(), ExecutionType.EMBEDDED.toString());

         JMXTestRunnerMBean testRunner = getMBeanProxy(mbeanServer, JMXTestRunnerMBean.OBJECT_NAME, JMXTestRunnerMBean.class);
         TestResult result = testRunner.runTestMethod(DummyTestCase.class.getName(), "testMethod", props);
      ...
      {
         mbeanServer.unregisterMBean(JMXTestRunnerMBean.OBJECT_NAME);
      }
   }
