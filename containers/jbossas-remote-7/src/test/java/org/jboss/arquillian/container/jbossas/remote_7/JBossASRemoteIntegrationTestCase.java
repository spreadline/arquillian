 ...
 */
package org.jboss.arquillian.container.jbossas.remote_7;
...
import org.jboss.arquillian.container.jbossas.remote_7.SimpleServiceActivator.SimpleService;
...
public class JBossASRemoteIntegrationTestCase
{
   final static Logger log = Logger.getLogger(JBossASRemoteIntegrationTestCase.class);
   ...
   public static JavaArchive createDeployment() throws Exception
   {
      ...
      URL resourceURL = JBossASRemoteIntegrationTestCase.class.getResource("/module/" + path);
